...
(function(e) {
	e.fn.notifyMe = function(t) {
		...
		var k = e(this).find("input[name=displayname]");
		var m = e(this).find("input[name=phone]");
		...
		e(this).on("submit", function(t) {
			...
			if (p.test(h) && j != '' && l != '') {
				...
				$(".block-message").addClass("show-block-error").removeClass("show-block-valid");
				$(".message").html('<p class="notify-valid">Your name, e-mail address and phone is incorrect.<br>Please check it and try again.</p>').fadeIn();
				o.hide();
			}
