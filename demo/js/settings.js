(function ($) {
	...
	var settings_block = '<div class="block-settings-wrapper">'+
							'<div id="block_settings" class="block_settings">'+
								'<section>'+
									'<span class="green" 		title="Green" 		data-color="#0fe0ba" />'+
									'<span class="blue" 		title="Blue" 		data-color="#1fb4da" />'+
	...
	function initColor() {
		$(".block-settings-wrapper section span").on("click", function() {
			...
			//CSS
			$("link.colors").attr("href", themeAssetUrl + "/css/colors/"+cls+".css");
			
			//Google Maps
			googleMaps(color, themeAssetUrl + "/images/map-marker-"+cls+".png");
		});
	}
